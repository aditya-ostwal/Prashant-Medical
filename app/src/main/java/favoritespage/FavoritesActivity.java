 ...
 * Slide And Drag
 */
public class FavoritesActivity extends androidx.fragment.app.Fragment implements AdapterView.OnItemLongClickListener,
            ...
            case MenuItem.DIRECTION_RIGHT:
                switch (buttonPosition) {
                    case 0:
                        ...
                        }.execute(MainActivity.server_url+"homepage.php","NumaraGetir",ekleStockCode);
                        dialog.show();
                                    ...
                                    new getData(getActivity()) {
                                        ...
                                        protected void onPostExecute(String s) {
                                            if (!s.equals("") && s != null) {
                                                ...
                                                Toast.makeText(getActivity(),  "The product could not be added to the cart!!!", Toast.LENGTH_SHORT).show();
                                            }
                                            dialog.dismiss();
                                            super.onPostExecute(s);
                                        }
    ...
    public void onItemDeleteAnimationFinished(View view, int position) {
        ...
        builder.setTitle("Remove from My Favorite List...");
        builder.setMessage("Should the product be removed from the Favorite List??");
        ...
        builder.setPositiveButton("Remove", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new getData(getActivity()){
                    ...
                    protected void onPostExecute(String s) {
                        if (!s.equals("")) {
                            Toast.makeText(getActivity(),  "Product Successfully Removed From Favorites...", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(getActivity(), "The Product Could Not Be Removed From Favorites...", Toast.LENGTH_SHORT).show();
                        }
                        dialog.dismiss();
                        super.onPostExecute(s);
                    }
