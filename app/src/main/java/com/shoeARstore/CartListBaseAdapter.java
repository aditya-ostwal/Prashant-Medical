            ...
            public void onClick(View v) {
                ...
                new getData(context){
                    ...
                    protected void onPostExecute(String s) {
                        if(!s.equals("") && s!=null){
                            Toast.makeText(c,  "Product Removed from Cart...", Toast.LENGTH_SHORT).show();
                            Intent gec=new Intent(c,HomeFragment.class);
                            gec.putExtra("fragment","4");
                            c.startActivity(gec);
                        }else {
                            Toast.makeText(c, "The product could not be removed from the cart!!!", Toast.LENGTH_SHORT).show();
                        }
                        dialog.dismiss();
        ...
        new getData(context){
            ...
            protected void onPostExecute(String s) {
                if(!s.equals("") && s!=null){
                    ...
                    Toast.makeText(c, "Product Failed to Update!!!", Toast.LENGTH_SHORT).show();
                }
                dialog.dismiss();
                super.onPostExecute(s);
            }
