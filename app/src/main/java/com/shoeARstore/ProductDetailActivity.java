...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    String encodedShareBody = URLEncoder.encode(shareBody, "UTF-8");
                    sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Subject Here");
                    sharingIntent.putExtra(Intent.EXTRA_TEXT, encodedShareBody);
                    startActivity(Intent.createChooser(sharingIntent, "Share Product"));
        ...
        favbuttonpasif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(kullaniciid.equals("0")){
                    Toast.makeText(ProductDetailActivity.this,   "Please Login!!!", Toast.LENGTH_SHORT).show();
                }else{
                    new getData(ProductDetailActivity.this){
                        @Override
                        protected void onPostExecute(String s) {
                            if(!s.equals("")){
                                Toast.makeText(c, "Product Successfully Added to Favorites...", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(c, "The Product Could Not Be Added To Favorites...", Toast.LENGTH_SHORT).show();
                            }
                            dialog.dismiss();
            ...
            public void onClick(View v) {
                if(kullaniciid.equals("0")){
                    ...
                    new getData(ProductDetailActivity.this) {
                        ...
                        protected void onPostExecute(String s) {
                            if (!s.equals("")) {
                                Toast.makeText(c, "Product Successfully Removed From Favorites...", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(c,  "The Product Could Not Be Removed From Favorites...", Toast.LENGTH_SHORT).show();
                            }
                            dialog.dismiss();
                            super.onPostExecute(s);
                        }
                    ...
                    public void onClick(View v) {
                        if(!shoesize.equals("") && !kullaniciid.equals("0")){
                            ...
                            new getData(ProductDetailActivity.this){
                                ...
                                protected void onPostExecute(String s) {
                                    if(!s.equals("") && s!=null){
                                        Toast.makeText(c, "Product Successfully Added to Cart...", Toast.LENGTH_SHORT).show();
                                        Intent gec=new Intent(c,HomeFragment.class);
                                        gec.putExtra("fragment","4");
                                        startActivity(gec);
                                    }
                                    else{
                                        Toast.makeText(c, "The product could not be added to the cart!!!", Toast.LENGTH_SHORT).show();
                                    }
                                    dialog.dismiss();
                                    super.onPostExecute(s);
                                }
                            ...
                            if(kullaniciid.equals("0")){
                                ...
                                uyari("Please Select One Option from product options");
                            }
                        }
            }
        });
                                ...
                                for (String picture : path.split(",")) {
                                    ...
                                    textSliderView.setOnSliderClickListener(new BaseSliderView.OnSliderClickListener() {
                                        ...
                                        public void onSliderClick(BaseSliderView slider) {
                                            ...
                                            Picasso.get().load(slider.getBundle().getString("path")).into(imageView);
    ...
    private void renkGetir(String productName, final LinearLayout productcolors, final int id) {
                ...
                if(s!=null){
                    ...
                    try{
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            path=path.replace("\\", "/");
                            Picasso.get().load(MainActivity.server_url+path).into(colorbox);
        ...
        }.execute(MainActivity.server_url+"homepage.php","RenkGetir",productName);
    }
