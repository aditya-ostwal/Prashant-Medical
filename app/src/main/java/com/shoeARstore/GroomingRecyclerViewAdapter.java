...
//        ***********ratingBar**********
    ...
    public void onBindViewHolder(final DataObjectHolder holder, int position) {
        ...
        Picasso.get().load(bean.get(position).getImage()).into(holder.image);
                ...
                if(!kullaniciid.equals("-1")){
                    ...
                    new getData(context){
                        ...
                        protected void onPostExecute(String s) {
                            if(!s.equals("")){
                                Toast.makeText(context, "Product Successfully Added to Favorites...", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(context, "The Product Could Not Be Added To Favorites...", Toast.LENGTH_SHORT).show();
                            }
                            dialog.dismiss();
            ...
            public void onClick(View v) {
                if(!kullaniciid.equals("-1")) {
                    ...
                    new getData(context) {
                        ...
                        protected void onPostExecute(String s) {
                            if (!s.equals("")) {
                                Toast.makeText(context, "Product Successfully Removed From Favorites...", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(context, "The Product Could Not Be Removed From Favorites...", Toast.LENGTH_SHORT).show();
                            }
                            dialog.dismiss();
                            super.onPostExecute(s);
                        }
