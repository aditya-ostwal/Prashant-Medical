...
public class addAdressActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras()!=null){
            ...
            if(adressAd.equalsIgnoreCase("Invoice")){
            ...
            new getData(addAdressActivity.this){
                ...
                protected void onPostExecute(String s) {
                    try {
                        ...
                        {
                            Toast.makeText(addAdressActivity.this, "Address Successfully Saved...", Toast.LENGTH_SHORT).show();
                            activityGec();
                        }
                        else {
                            Toast.makeText(addAdressActivity.this, "Address Could Not Be Saved...Please Check The Information You Have Entered!!!", Toast.LENGTH_SHORT).show();
                        }
