...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1611invokeWpGqRn0(((ChannelResult) obj).m1607unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1611invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1595boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object it = ((ChannelResult) this.L$0).m1607unboximpl();
                Throwable it2 = ChannelResult.m1599exceptionOrNullimpl(it);
                if (it2 != null) {
                    throw it2;
                }
                Object m1600getOrNullimpl = ChannelResult.m1600getOrNullimpl(it);
                this.label = 1;
                Object it3 = this.$block.invoke(m1600getOrNullimpl, this);
