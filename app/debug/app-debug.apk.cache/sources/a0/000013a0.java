...
public class MultiViewUpdateListener implements ValueAnimator.AnimatorUpdateListener {
    ...
    public static MultiViewUpdateListener alphaListener(View... views) {
        return new MultiViewUpdateListener(MultiViewUpdateListener$$ExternalSyntheticLambda3.INSTANCE, views);
    }
    ...
    public static MultiViewUpdateListener scaleListener(View... views) {
        return new MultiViewUpdateListener(MultiViewUpdateListener$$ExternalSyntheticLambda1.INSTANCE, views);
    }
    ...
    public static MultiViewUpdateListener translationXListener(View... views) {
        return new MultiViewUpdateListener(MultiViewUpdateListener$$ExternalSyntheticLambda2.INSTANCE, views);
    }
    ...
    public static MultiViewUpdateListener translationYListener(View... views) {
        return new MultiViewUpdateListener(MultiViewUpdateListener$$ExternalSyntheticLambda0.INSTANCE, views);
    }
