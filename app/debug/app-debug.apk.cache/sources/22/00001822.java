        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m665contentEqualskV0jMPg(((UByteArray) t).m183unboximpl(), ((UByteArray) t2).m183unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m662contentEqualsFGO6Aew(((UShortArray) t).m443unboximpl(), ((UShortArray) t2).m443unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m663contentEqualsKJPZfPQ(((UIntArray) t).m261unboximpl(), ((UIntArray) t2).m261unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m667contentEqualslec5QzE(((ULongArray) t).m339unboximpl(), ((ULongArray) t2).m339unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m679contentToString2csIQuQ(uByteArray != null ? uByteArray.m183unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m683contentToStringd6D3K8(uShortArray != null ? uShortArray.m443unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m682contentToStringXUkPCBk(uIntArray != null ? uIntArray.m261unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m685contentToStringuLth9ew(uLongArray != null ? uLongArray.m339unboximpl() : null));
            } else {
