    ...
    private final zzl zza(String str, int i) {
        try {
            ...
            if (zza2.signatures != null && zza2.signatures.length == 1) {
                ...
                if (zza3.zza && zza2.applicationInfo != null && (zza2.applicationInfo.flags & 2) != 0 && zzc.zza(str2, zzgVar, false, true).zza) {
    ...
    private final zzl zza(String str) {
        ...
        try {
            ...
            if (packageInfo == null) {
                ...
                zzl zza3 = zzc.zza(str2, zzgVar, honorsDebugCertificates, false);
                if (zza3.zza && packageInfo.applicationInfo != null && (packageInfo.applicationInfo.flags & 2) != 0 && zzc.zza(str2, zzgVar, false, true).zza) {
                    zza2 = zzl.zza("debuggable release cert app rejected");
                } else {
                    zza2 = zza3;
                }
            }
