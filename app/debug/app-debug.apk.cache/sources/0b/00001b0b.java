...
public interface TimeMark {
    ...
    TimeMark mo1407minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1408plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1550plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1549minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1408plusLRDsOJo(Duration.m1466unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1447isNegativeimpl($this.mo1406elapsedNowUwyO8pc());
        }
