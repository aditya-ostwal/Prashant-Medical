...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m99constructorimpl = Result.m99constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        if (newInstance != null) {
                            ...
                            it.initCause(e);
                            m99constructorimpl = Result.m99constructorimpl(it);
                            if (Result.m105isFailureimpl(m99constructorimpl)) {
                                m99constructorimpl = null;
                            }
                            return (Throwable) m99constructorimpl;
                        }
            ...
            case 1:
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        if (newInstance != null) {
                            m99constructorimpl = Result.m99constructorimpl((Throwable) newInstance);
                            if (Result.m105isFailureimpl(m99constructorimpl)) {
                                m99constructorimpl = null;
                            }
                            return (Throwable) m99constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m99constructorimpl = Result.m99constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m99constructorimpl = Result.m99constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        Integer m99constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m99constructorimpl = Result.m99constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m99constructorimpl = Result.m99constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m105isFailureimpl(m99constructorimpl)) {
            m99constructorimpl = valueOf;
        }
        return ((Number) m99constructorimpl).intValue();
    }
