...
public final class AnimatorSet extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo90clone() {
        AnimatorSet anim = (AnimatorSet) super.mo90clone();
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m91clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo90clone();
                return node;
