    ...
    */
    public long read(okio.Buffer r9, long r10) throws java.io.IOException {
        ...
        Lf:
            ...
            int r2 = (int) r2     // Catch: java.util.zip.DataFormatException -> L6d
            java.util.zip.Inflater r3 = r8.inflater     // Catch: java.util.zip.DataFormatException -> L6d
            byte[] r4 = r1.data     // Catch: java.util.zip.DataFormatException -> L6d
            int r5 = r1.limit     // Catch: java.util.zip.DataFormatException -> L6d
            int r3 = r3.inflate(r4, r5, r2)     // Catch: java.util.zip.DataFormatException -> L6d
            if (r3 <= 0) goto L3b
            ...
            long r6 = (long) r3     // Catch: java.util.zip.DataFormatException -> L6d
            long r4 = r4 + r6
            r9.size = r4     // Catch: java.util.zip.DataFormatException -> L6d
            long r4 = (long) r3     // Catch: java.util.zip.DataFormatException -> L6d
            return r4
        L3b:
