...
public interface ReceiveChannel<E> {
    ...
    Object mo1589tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.mo1589tryReceivePtdJZtk();
            if (ChannelResult.m1605isSuccessimpl(result)) {
                return (E) ChannelResult.m1601getOrThrowimpl(result);
            }
            Throwable m1599exceptionOrNullimpl = ChannelResult.m1599exceptionOrNullimpl(result);
            if (m1599exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1599exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L2d:
                ...
                java.lang.Object r3 = r3.m1607unboximpl()
                goto L45
            L38:
                kotlin.ResultKt.throwOnFailure(r0)
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1588receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1600getOrNullimpl(r3)
                return r3
            */
