...
public class SliderLayout extends RelativeLayout {
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mh = new Handler() { // from class: slider.library.SliderLayout.2
        ...
        int i = 0;
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, com.shoeARstore.R.styleable.SliderLayout, defStyle, 0);
        ...
        this.mViewPager.setOnTouchListener(new View.OnTouchListener() { // from class: slider.library.SliderLayout.1
    ...
    public void startAutoCycle(long delay, long duration, boolean autoRecover) {
        ...
        TimerTask timerTask3 = new TimerTask() { // from class: slider.library.SliderLayout.3
    ...
    public void recoverCycle() {
        ...
        if (this.mAutoRecover && this.mAutoCycle && !this.mCycling) {
            ...
            TimerTask timerTask = new TimerTask() { // from class: slider.library.SliderLayout.4
                @Override // java.util.TimerTask, java.lang.Runnable
                public void run() {
    ...
    /* renamed from: slider.library.SliderLayout$5  reason: invalid class name */
    /* loaded from: classes9.dex */
    public static /* synthetic */ class AnonymousClass5 {
        static final /* synthetic */ int[] $SwitchMap$slider$library$SliderLayout$Transformer;

        static {
            int[] iArr = new int[Transformer.values().length];
            $SwitchMap$slider$library$SliderLayout$Transformer = iArr;
            try {
                iArr[Transformer.Default.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.Accordion.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.Background2Foreground.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.CubeIn.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.DepthPage.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.Fade.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.FlipHorizontal.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.FlipPage.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.Foreground2Background.ordinal()] = 9;
            } catch (NoSuchFieldError e9) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.RotateDown.ordinal()] = 10;
            } catch (NoSuchFieldError e10) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.RotateUp.ordinal()] = 11;
            } catch (NoSuchFieldError e11) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.Stack.ordinal()] = 12;
            } catch (NoSuchFieldError e12) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.Tablet.ordinal()] = 13;
            } catch (NoSuchFieldError e13) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.ZoomIn.ordinal()] = 14;
            } catch (NoSuchFieldError e14) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.ZoomOutSlide.ordinal()] = 15;
            } catch (NoSuchFieldError e15) {
            }
            try {
                $SwitchMap$slider$library$SliderLayout$Transformer[Transformer.ZoomOut.ordinal()] = 16;
    ...
    public void setPresetTransformer(Transformer ts) {
        ...
        switch (AnonymousClass5.$SwitchMap$slider$library$SliderLayout$Transformer[ts.ordinal()]) {
            case 1:
