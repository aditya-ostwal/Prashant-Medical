    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo1637scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m1572delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m1573toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1573toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1413compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m1516getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1432getInWholeMillisecondsimpl($this$toDelayMillis), 1L);
        }
        return 0L;
    }
}