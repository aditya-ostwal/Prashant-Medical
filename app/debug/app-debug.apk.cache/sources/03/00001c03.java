...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object $this$onSuccess$iv = sendChannel.mo1590trySendJP2dKIU(e);
        if ($this$onSuccess$iv instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1607unboximpl();
        }
        Unit unit = (Unit) $this$onSuccess$iv;
        return ChannelResult.Companion.m1610successJP2dKIU(Unit.INSTANCE);
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m1605isSuccessimpl(sendChannel.mo1590trySendJP2dKIU(e))) {
