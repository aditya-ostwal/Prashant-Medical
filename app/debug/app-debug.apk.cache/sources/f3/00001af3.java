...
public final class UStringsKt {
    ...
    public static final String m1403toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1405toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1404toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1402toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m426unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m244unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m322unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m244unboximpl = uIntOrNull.m244unboximpl();
            if (UnsignedKt.uintCompare(m244unboximpl, UInt.m193constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m111boximpl(UByte.m117constructorimpl((byte) m244unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m244unboximpl = uIntOrNull.m244unboximpl();
            if (UnsignedKt.uintCompare(m244unboximpl, UInt.m193constructorimpl(65535)) > 0) {
                return null;
            }
            return UShort.m371boximpl(UShort.m377constructorimpl((short) m244unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m446uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m271constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UnsignedKt.m448ulongDivideeb3DHEI(-1L, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            long result2 = ULong.m271constructorimpl(result * uradix);
            result = ULong.m271constructorimpl(ULong.m271constructorimpl(UInt.m193constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m265boximpl(result);
    }
}