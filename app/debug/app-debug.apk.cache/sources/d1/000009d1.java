    ...
    public <T extends ViewModel> T create(Class<T> modelClass, CreationExtras extras) {
        ...
        if (extras.get(SavedStateHandleSupport.SAVED_STATE_REGISTRY_OWNER_KEY) != null && extras.get(SavedStateHandleSupport.VIEW_MODEL_STORE_OWNER_KEY) != null) {
            ...
            if (!isAndroidViewModel || application == null) {
                ...
                constructor = SavedStateViewModelFactoryKt.findMatchingConstructor(modelClass, list);
            } else {
                list2 = SavedStateViewModelFactoryKt.ANDROID_VIEWMODEL_SIGNATURE;
                constructor = SavedStateViewModelFactoryKt.findMatchingConstructor(modelClass, list2);
            }
            if (constructor == null) {
