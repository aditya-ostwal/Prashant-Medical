...
public final class AgentPremain {
    ...
    static {
        ...
        Boolean bool = Result.m105isFailureimpl(m99constructorimpl) ? null : m99constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1612installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1612installSignalHandler$lambda1(Signal it) {
