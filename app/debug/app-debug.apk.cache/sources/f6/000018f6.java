...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            ?? r4 = $this$resumeWith_u24lambda_u2d0.completion;
            Intrinsics.checkNotNull(r4);
            try {
                outcome = $this$resumeWith_u24lambda_u2d0.invokeSuspend(param);
            } catch (Throwable exception) {
                Result.Companion companion = Result.Companion;
                m99constructorimpl = Result.m99constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.Companion;
            m99constructorimpl = Result.m99constructorimpl(outcome);
            Object outcome2 = m99constructorimpl;
